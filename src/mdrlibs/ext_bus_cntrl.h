...
typedef volatile _ext_bus_cntrl_ext_bus_control
    _io_ext_bus_cntrl_ext_bus_control;
...
#define mask_EXT_BUS_CNTRL_EXT_BUS_CONTROL_WAIT_STATE \
  ((unsigned long)0x0000F000)
